...
from order_worker.sites import domeggook_registration, domesin_registration, laf, namdo_registration, onchannel_registration, ownerclan_registration, specialoffer_registration
