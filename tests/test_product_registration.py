...
class ProductRegistrationTests(unittest.IsolatedAsyncioTestCase):
    async def test_dispatches_mixed_accounts_in_requested_order(self):
        ...
        with patch.dict(
            ...
            {"ownerclan": owner_runner, "onch3": onchannel_runner, "domeggook": domeggook_runner, "specialoffer": specialoffer_runner, "domesin": domesin_runner},
            clear=True,
        ):
        ...
        self.assertEqual([result["siteCode"] for result in results], ["ownerclan", "onch3", "domeggook", "specialoffer", "domesin"])
        ...
        self.assertEqual(progress, [("ownerclan", 0), (None, 1), ("onch3", 1), (None, 2), ("domeggook", 2), (None, 3), ("specialoffer", 3), (None, 4), ("domesin", 4), (None, 5)])
